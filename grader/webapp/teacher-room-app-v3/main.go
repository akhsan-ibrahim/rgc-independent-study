...
func main() {
	os.Setenv("DATABASE_URL", "postgres://akhsan:password@localhost:5432/dbakhsan") // Hapus jika akan melakukan deploy ke fly.io
...
func FlyURL() string {
	...
	return "https://akhsanibrahim-be2777445.fly.dev" // TODO: replace this
}
